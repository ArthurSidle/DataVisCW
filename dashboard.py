...
title['basics'].drop(title['basics'][
    (title['basics'].titleType == 'short') |
    (title['basics'].titleType == 'tvEpisode') |
    (title['basics'].titleType == 'tvSpecial') |
    (title['basics'].titleType == 'tvShort') |
    (title['basics'].titleType == 'videoGame')
].index, inplace=True)
